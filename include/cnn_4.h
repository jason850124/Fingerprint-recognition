...
/*
 * This header file was automatically @generated for the finger-112 network from a template.
...
/*
  SUMMARY OF OPS
  Hardware: 431,020,032 ops (425,801,728 macc; 4,848,256 comp; 370,048 add; 0 mul; 0 bitwise)
    Layer 0: 8,028,160 ops (7,225,344 macc; 802,816 comp; 0 add; 0 mul; 0 bitwise)
  ...
  RESOURCE USAGE
  Weight memory: 908,800 bytes out of 2,396,160 bytes total (37.9%)
  Bias memory:   7,296 bytes out of 8,192 bytes total (89.1%)
*/

/* Number of outputs for this network */
#define CNN_4_NUM_OUTPUTS 64 //32

/* Use this timer to time the inference */
#define CNN_4_INFERENCE_TIMER MXC_TMR0
...
int cnn_4_enable(uint32_t clock_source, uint32_t clock_divider);

/* Disable clocks and power to accelerator */
int cnn_4_disable(void);

/* Perform minimum accelerator initialization so it can be configured */
int cnn_4_init(void);

/* Configure accelerator for the given network */
int cnn_4_configure(void);

/* Load accelerator weights */
int cnn_4_load_weights(void);

/* Verify accelerator weights (debug only) */
int cnn_4_verify_weights(void);

/* Load accelerator bias values (if needed) */
int cnn_4_load_bias(void);

/* Start accelerator processing */
int cnn_4_start(void);

/* Force stop accelerator */
int cnn_4_stop(void);

/* Continue accelerator after stop */
int cnn_4_continue(void);

/* Unload results from accelerator */
int cnn_4_unload(uint32_t *out_buf);
